...
class Vwupdate1(nn.Module):
    def __init__(self,
        ...
        self.in_conv3 = DoubleConv(base_c * 4, base_c)
        ...
        self.secmodel1 = U_Net(64)
        self.secmodel2 = U_Net(64)
    ...
    def forward(self, x: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        x1_2 = torch.cat((x1, x9), 1)
        x9_2,logits_2 = self.secmodel1(x1_2)
        # logits_2 = self.out_conv_2(x9_2)
